...
export default function Casa() {
    ...
    return (
        <main className={style.containerCasa}>
                ...
                <div className={style.cardContainer}>
                    {resposta &&
                        resposta.map((characters, index) => {
                            return (
                                <div key={index}>
                                    <div className={style.listPersonagens}>
                                        ...
                                        <p className={style.casaNome}>{characters.name}</p>
                                        <p className={style.casaHouse}>{characters.house}</p>
                                    </div>
                                </div>
                            ...
                            console.log(resposta.resposta?.characters.name, 'ooioiio'),
